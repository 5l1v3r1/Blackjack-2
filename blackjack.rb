...
class BlackJack
  ...
  def startGame 
    ...
    if @bet >= 10
        ...
        #@generic.list_all_cards(@dealer.dealer_cards,@dealer.get_dealer_cards_value,'dealer')
        ...
        puts "\nNo of games #{@counter}".colorize(:cyan)
          ...
          if(@counter % 50 == 0 || @person.bank == 0.0)
